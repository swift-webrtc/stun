...
extension STUNAttribute.Value.ErrorCode {
  ...
  internal init(bytes: Array<UInt8>) throws {
    ...
    guard
      ...
      throw STUNError.invalidErrorCodeValue
    }

    self = .init(code: UInt16(c) * 100 + UInt16(n), reasonPhrase: r)
  }
}
...
// MARK: - STUNAttribute.Value.ErrorCode + Equatable

extension STUNAttribute.Value.ErrorCode: Equatable {
